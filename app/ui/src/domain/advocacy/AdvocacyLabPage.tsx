...
export function AdvocacyLabPage() {
  ...
  const initializeSession = async () => {
    setIsLoading(true);
    try {
      const session = await createSession('iep_meeting', 'Practice Meeting Communication', selectedChildId || undefined);
      ...
      <div className="border-b bg-white dark:bg-slate-900 p-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Badge variant="outline" className="text-primary">Goal: Practice Meeting Communication</Badge>
