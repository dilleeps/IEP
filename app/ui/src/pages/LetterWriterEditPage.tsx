  ...
  function useTemplate(templateKey: string) {
    ...
    if (template) {
      ...
      if (child) {
        ...
        // Auto-fill accommodations context if available
        if (child.accommodationsSummary) {
          populatedContent = populatedContent.replace(
            /\[List your specific concerns or topics here\]/g,
            `Current accommodations:\n${child.accommodationsSummary}`
          );
        }
      }
      ...
      // Replace contact info if user has email
      if (user?.email) {
        populatedContent = populatedContent.replace(/\[Contact Information\]/g, user.email);
      }
        ...
        <section className="space-y-4 py-4">
          ...
          <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Professional, formal letters help maintain organized records for advocacy. Keep copies of all sent letters.
              </p>
            </div>
        </section>
