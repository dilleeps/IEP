    ...
    const load = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          accommodations: found.accommodationsSummary || "",
          services: found.servicesSummary || "",
        });
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-6 pb-32 max-w-6xl mx-auto w-full">
        ...
        <section className="space-y-4 py-4">
          ...
          {/* School Name */}
          <div className="grid grid-cols-[90px_1fr] items-center gap-3">
            <Label className="text-right text-sm">School</Label>
            <Input
          ...
          {/* Country + Phone */}
          <div className="grid grid-cols-[90px_1fr_90px_1fr] items-center gap-3">
