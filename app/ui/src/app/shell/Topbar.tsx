...
import { Menu, Bell, X, CheckCircle, Info, AlertTriangle, XCircle, ArrowLeft, Sun, Moon, Globe, HelpCircle } from "lucide-react";
      ...
      <div className="flex h-16 items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          >
            ...
            <span className="ml-1 text-xs font-semibold">{language === "en" ? "EN" : "ES"}</span>
          </Button>
              ...
              <div className="max-h-[32rem] overflow-y-auto">
                {notifications.length === 0 ? (
                  <div className="py-12 px-4 text-center">
                    ...
                    <p className="text-sm font-medium text-muted-foreground">{t.topbar.allCaughtUp}</p>
                    <p className="mt-1 text-xs text-muted-foreground">{t.topbar.noNotifications}</p>
                  </div>
                ) : (
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={handleLogout}>{t.topbar.logout}</DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
      </div>
