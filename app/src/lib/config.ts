...
const apiBaseUrl = normalizeBaseUrl(
  typeof env.VITE_BASE_API_URL === 'string' ? env.VITE_BASE_API_URL : 'http://localhost:3000',
);
...
export const config = {
  ...
  api: {
    ...
    endpoints: {
      ...
      counselor: {
        serviceMetadata: "/api/v1/counselor/service-metadata",
        services: "/api/v1/counselor/services",
        serviceById: (id: string) => `/api/v1/counselor/services/${id}`,
        availability: "/api/v1/counselor/availability",
        profile: "/api/v1/counselor/profile",
        googleConnectUrl: "/api/v1/counselor/google/connect-url",
        appointments: "/api/v1/counselor/appointments",
        appointmentById: (id: string) => `/api/v1/counselor/appointments/${id}`,
        appointmentStatusById: (id: string) => `/api/v1/counselor/appointments/${id}/status`,
        appointmentMeetLinkById: (id: string) => `/api/v1/counselor/appointments/${id}/meet-link`,
        catalog: "/api/v1/counselor/catalog",
        catalogSlots: (id: string, date: string) => `/api/v1/counselor/catalog/${id}/slots?date=${encodeURIComponent(date)}`,
        counselors: "/api/v1/counselor/counselors",
        counselorSlots: (counselorId: string, date: string, duration: number) =>
          `/api/v1/counselor/counselors/${counselorId}/slots?date=${encodeURIComponent(date)}&duration=${duration}`,
        parentAppointments: "/api/v1/counselor/appointments",
        myAppointments: "/api/v1/counselor/appointments/mine",
        myAppointmentById: (id: string) => `/api/v1/counselor/appointments/mine/${id}`,
        myAppointmentPaymentSessionById: (id: string) => `/api/v1/counselor/appointments/mine/${id}/payment/session`,
        myAppointmentPaymentById: (id: string) => `/api/v1/counselor/appointments/mine/${id}/payment`,
      },

      consultation: {
        availableSlots: "/api/v1/consultations/slots",
        availableSlotsForDate: (date: string) => `/api/v1/consultations/slots?date=${encodeURIComponent(date)}`,
        book: "/api/v1/consultations/book",
        mine: "/api/v1/consultations/mine",
        cancelMine: (id: string) => `/api/v1/consultations/mine/${id}/cancel`,
        adminSlots: "/api/v1/consultations/slots",
        adminSlotsBulk: "/api/v1/consultations/slots/bulk",
        adminDeleteSlot: (id: string) => `/api/v1/consultations/slots/${id}`,
        adminAll: "/api/v1/consultations/all",
        adminUpdate: (id: string) => `/api/v1/consultations/${id}`,
      },
      ...
      plans: {
        public: "/api/v1/plans",
        adminList: "/api/v1/admin/plans",
        adminGet: "/api/v1/admin/plans/:id",
        adminCreate: "/api/v1/admin/plans",
        adminUpdate: "/api/v1/admin/plans/:id",
        adminDelete: "/api/v1/admin/plans/:id",
        checkout: "/api/v1/plans/:id/checkout",
      },
  ...
  // =========================
    ...
    // Billing routes
    billing: "/billing",
    billingCheckout: (planSlug: string) => `/billing/checkout/${planSlug}`,
  },
