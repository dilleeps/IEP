      ...
      <div className="border-b bg-white dark:bg-slate-900 p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-semibold">IDEA Information Center</h1>
              <p className="text-sm text-muted-foreground">Learn about IDEA regulations and special education processes</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <Badge variant="outline" className="text-primary">AI Education Rights Guide</Badge>
        ...
        <div className="flex-1 flex flex-col">
          ...
          <Alert className="mx-4 mt-4 border-amber-200 bg-amber-50 dark:bg-amber-950 dark:border-amber-800">
            ...
            <AlertDescription className="text-sm">
              AskIEP provides AI-generated informational guidance about IDEA and related processes. This is educational information only — not legal advice.
              Laws vary by state; consult a licensed attorney for specific legal matters.
            </AlertDescription>
          </Alert>
